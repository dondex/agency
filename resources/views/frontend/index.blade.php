          ...
          <div class="row justify-content-center">
                ...
                @foreach ($all_news as $newsitem)
                    <div class="col-lg-4 col-md-6 mb-5">
                        <div class="card bg-transparent border-0">
                            <img
                            loading="lazy"
                            src="{{ asset('uploads/news/'.$newsitem->image)}}"
                            alt="news"
                            class="img-fluid-news rounded"
                            ...
                            <div class="blog-item-meta">
                                ...
                                >NEWS AND ARTICLES about Philworld Recruitment Agency Inc.<span class="ml-2 mr-2"></span></a
                                >
            ...
            {{-- <div class="col-lg-4 col-md-6 mb-5">
              <div class="card border-0 bg-transparent">
                <img
                  loading="lazy"
                  src="{{ asset('assets/images/blog/2.jpg')}}"
                  alt="blog"
            ...
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="card border-0 bg-transparent">
                <img
                  loading="lazy"
                  src="{{ asset('assets/images/blog/3.jpg')}}"
                  alt="blog"
                  class="img-fluid rounded"
                />
